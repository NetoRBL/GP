<?php
  ...
  if (!empty($cadastro) and (empty($dificuldade) or empty($disciplina) or empty($concurso) or empty($conteudo) or empty($enunciado) or empty($alternativa_1) or empty($alternativa_2) or empty($alternativa_3) or empty($alternativa_4))) {
    ?>
      ...
      <div class="control-group validate-form">
        ...
        <div  class=" form-group floating-label-form-group controls mb-0 pb-2">
          ...
          <div class="wrap-input100 validate-input" data-validate = "enunciado">
            <textarea class="input100" name="enunciado" id="enunciado" placeholder="Enunciado"><?=$enunciado?></textarea>
          ...
          <div class="wrap-input100 validate-input" data-validate = "alternativa_1" style="border-radius: 15px;">
            <textarea class="input100" name="alternativa_1" id="alternativa_1" placeholder="Alternativa 1"><?=$alternativa_1?></textarea>
            <span class="focus-input100"></span>
         </div>
       

          <div class="wrap-input100 validate-input" data-validate = "alternativa_2" style="border-radius: 15px;">
            <textarea class="input100" name="alternativa_2" id="alternativa_2" placeholder="Alternativa 2" style="border-radius: 15px;"><?=$alternativa_2?></textarea>
            <span class="focus-input100"></span>
         </div>

          <div class="wrap-input100 validate-input" data-validate = "alternativa_3" style="border-radius: 15px;">
            <textarea class="input100" name="alternativa_3" id="alternativa_3" placeholder="Alternativa 3"><?=$alternativa_3?></textarea>
            <span class="focus-input100"></span>
         </div>


          <div class="wrap-input100 validate-input" data-validate = "alternativa_4" style="border-radius: 15px;">
            <textarea class="input100" name="alternativa_4" id="alternativa_4" placeholder="Alternativa 4"><?=$alternativa_4?></textarea>
            <span class="focus-input100"></span>
         </div>

          <div class="wrap-input100 validate-input" data-validate = "alternativa_5" style="border-radius: 15px;">
            <textarea class="input100" name="alternativa_5" id="alternativa_5" placeholder="Alternativa 5"><?=$alternativa_5?></textarea>
            <span class="focus-input100"></span>
         </div>
